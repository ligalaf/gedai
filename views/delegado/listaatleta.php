            ...
            <div class='col-xs-12'>
                <div class="page-title">
                    ...
                    <ol class="breadcrumb primary">
                        ...
                        <li class="active">
                            <strong><i class="fa fa-user"></i>Lista de Atletas</strong>
                        </li>
                    </ol>
            ...
            <div class="col-lg-12">
                <section class="box ">
                    <header class="panel_header">
                        <h2 class="title pull-left">Lista de Atletas</h2>
...
<script src="../../js/Delegado/listaatleta.js" type="text/javascript"></script>
