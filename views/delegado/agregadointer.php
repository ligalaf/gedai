...
$validate ->ValidarPermissao($_SESSION['usuarioid'],9);
            ...
            <div class='col-xs-12'>
                <div class="page-title">
                    ...
                    <ol class="breadcrumb primary">
                        ...
                        <li class="active">
                            <strong><i class="fa fa-user"></i>Selecionar Agregado/Outros Inter</strong>
            ...
            <div class="col-lg-12">
                <section class="box ">
                    <header class="panel_header">
                        <h2 class="title pull-left">Selecionar Agregado/Outros Inter</h2>
...
<script src="../../js/delegado/listagregadointer.js" type="text/javascript"></script>
