...
$validate ->ValidarPermissao($_SESSION['usuarioid'],10);
            ...
            <div class='col-xs-12'>
                <div class="page-title">
                    ...
                    <ol class="breadcrumb primary">
                        ...
                        <li class="active">
                            <strong><i class="fa fa-user"></i>Lista de Atletas Inter</strong>
                        </li>
                    </ol>
            ...
            <div class="col-lg-12">
                <section class="box ">
                    <header class="panel_header">
                        <h2 class="title pull-left">Lista de Atletas Inter</h2>
...
<script src="../../js/laf/listaatletainter.js" type="text/javascript"></script>
