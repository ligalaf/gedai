...
<html class="">
    <head>
        ...
        <link href="/fonts/font-awesome/web-fonts-with-css/css/fontawesome-all.css" rel="stylesheet" type="text/css" />
        ...
        <!-- Multi Select Start Plugin -->
        <link href="/plugins/jquery-ui/smoothness/jquery-ui.min.css" rel="stylesheet" type="text/css" media="screen"/>
        <link href="/plugins/multi-select/css/multi-select.css" rel="stylesheet" type="text/css" media="screen"/>
        <!-- Multi Select End Plugin -->

        <!-- DropZone Start Plugin -->
        <link href="/plugins/dropzone/css/dropzone.min.css" rel="stylesheet" type="text/css">
        <!-- DropZone End Plugin -->

        <!--Lightbox Start Plugin -->
        <link href="/plugins/lightbox2-master/css/lightbox.css" rel="stylesheet" type="text/css">
        <!--Lightbox End Plugin -->
