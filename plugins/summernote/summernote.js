...
var dialog = renderer.create('<div class="modal" aria-hidden="false" tabindex="-1"/>', function ($node, options) {
    ...
    $node.html([
        ...
        (options.footer
            ? '    <div class="modal-footer">' + options.footer + 
...
$$1.fn.extend({
    ...
    summernote: function () {
        ...
        // Update options
        options.langInfo = $$1.extend(true, {}, $$1.summernote.lang['pt-BR'], $$1.summernote.lang[options.lang]);
...
$$1.summernote = $$1.extend($$1.summernote, {
    ...
    options: {
        ...
        toolbar: [
            ...
            //['table', ['table']],
            ['insert', ['link', 'video']], //['insert', ['link', 'picture', 'video']],
            ['view', ['codeview', 'help']] //['view', ['fullscreen', 'codeview', 'help']]
        ],
        // popover
        popatmouse: true,
        popover: {
